...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::scan_library, commands::scan_library_kind, commands::library_scan_progress, commands::list_users, commands::create_user, commands::rename_user, commands::delete_user,
